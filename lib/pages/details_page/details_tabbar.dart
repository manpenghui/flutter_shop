...
class DetailsTabBar extends StatelessWidget {
    ...
    return Provide<DetailsInfoProvide>(
      builder: (context,child,val){
        ...
        return Container(
          ...
          child: Row(
            children: <Widget>[
              myTabBarLeft(context,isLeft),
              myTabBarRight(context,isRight)
            ],
          ),
        );
  ...
  Widget myTabBarLeft(BuildContext context, bool isLeft){
    return InkWell(
      onTap: (){
      ...
      child: Container(
        ...
        child: Text('详情', style: TextStyle(
          color: isLeft? Colors.pink: Colors.black38,
        ),),
      ),
    );
  }
  Widget myTabBarRight(BuildContext context, bool isRight){
    return InkWell(
      onTap: (){
